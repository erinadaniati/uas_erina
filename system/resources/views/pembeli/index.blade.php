	...
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url({{url('public/pembeli')}}/images/1.jpeg)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title" style="color: white; margin-top: -130px;">SIPEMINUM</div>
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url({{url('public/pembeli')}}/images/2.jpeg)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url({{url('public/pembeli')}}/images/3.jpeg)"></div>
					<div class="home_slider_content">
						<div class="container">
							<div class="row">
								<div class="col text-center">
	...
	<div class="courses">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Produk SIPEMINUM</h2>
			...
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col"><br>
					<div class="course">
						<div class="course_image"><img src="{{url('app/produk', $produk->gambar)}}" alt=""></div><br>
